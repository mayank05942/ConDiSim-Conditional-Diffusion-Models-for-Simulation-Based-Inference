...
def generate_plots(task_name):
    """
    Generates and saves histogram plots for all posterior samples in the specified task.

    Parameters:
    - task_name (str): Name of the task to generate plots for.
    """
    ...
    # Get true posterior samples once if possible
    try:
    ...
    for file in os.listdir(results_dir):
        # Filter to process only relevant posterior sample files
